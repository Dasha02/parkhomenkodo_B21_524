...
image = np.array(Image.open('scls.png'))

resized_image = interpolate_image(image, 2)
Image.fromarray(resized_image).save('resized_image_interpolated.png')

resized_image = decimate_image(image, 3)
Image.fromarray(resized_image).save('resized_image_decimated.png')

resampled_image = resample_image(image, 2, 3)
Image.fromarray(resampled_image).save('resampled_image.png')

resampled_image = resample_image_single_pass(image, 1.5)
Image.fromarray(resampled_image).save('resampled_image_single_pass.png')
...
image = np.array(Image.open('muar.png'))
